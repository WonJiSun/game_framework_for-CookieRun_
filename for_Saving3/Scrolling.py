...
class Background:
    ...
    def __init__(self, w, h):
        self.image = load_image('backG_stage1_1.png') # backG_stage1_1.png
    ...
    def Timer_Now(self):
        ...
        if(self.current_time > 20) :
            if self.Changed_stage2 == False :
                self.image = load_image('backG_stage2_1.png')
...
class Background2:
    ...
    def __init__(self, w, h):
        self.image = load_image('backG_stage1_2.png') # backG_stage1_1.png
    ...
    def Timer_Now(self):
        ...
        if(self.current_time > 20) :
            if self.Changed_stage2 == False :
                self.image = load_image('backG_stage2_4.png')
                self.Changed_stage2 = True